        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Ensure there is a HOTEL_ROLE
                    RoleResult = await _roleManager.FindByNameAsync(HOTEL_ROLE);
                    if (RoleResult == null)
                    {
                        // Create HOTEL_ROLE role.
                        await _roleManager.CreateAsync(new IdentityRole(HOTEL_ROLE));
                    }
